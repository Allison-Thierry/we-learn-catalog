...
const faqItems: [string, React.ReactNode][] = [
  ...
  ["I can't log in to WeLearn. What should I do?", "Your official RGIS credentials and WeLearn credentials are linked: there is no separate WeLearn login. If you only have RGIS Mail access, use your RGIS Mail credentials. If you have a professional email address ending in @rgis.com, sign in with that email address and your Windows session password."],
